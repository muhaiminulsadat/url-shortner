...
export default function LoginForm() {  
  ...
  const handleSubmit = (e) => {
    ...
    authClient.signIn.email(formData, {  // 👈 removed unused `const {data} =`
      ...
      <div className="card w-full max-w-md bg-base-200/50 shadow-sm border border-base-300">
        <div className="card-body gap-6">
          <div className="text-center">
            ...
            <p className="text-sm opacity-60 mt-2">Login to manage your links</p>
          </div>
          ...
          <div className="divider text-xs opacity-40 uppercase font-bold">OR</div>
